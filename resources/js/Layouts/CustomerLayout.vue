        ...
        <div :class="{'w-72 ': showingNavigationDropdown, 'w-0': ! showingNavigationDropdown}"  class="flex flex-col flex-none bg-blue-600 transition-all duration-300 ease-in text-white overflow-hidden">
            ...
            <div class=" flex-none w-56 mx-auto pb-10 h-[100vh] overflow-y-auto scrollbar-hide">
                <div class=" text-center my-10 flex flex-col space-y-5">
                    ...
                    <h3 class="text-xl font-semibold">SEAFARI MALDIVES</H3>
                </div>
                <nav class="flex flex-col " >
                    <NavLink class="hover:pl-5" :href="route('customer_dashboard')" >DASHBOARD</NavLink>
                    <NavLink class="hover:pl-5" :href="route('customer_orders')" >ORDERS</NavLink>
                    <NavLink class="hover:pl-5" :href="route('customer_invoice')" >INVOICES</NavLink>
                    ...
                    <div  class="flex flex-col ml-5 bg-blue-600 transition-all duration-500 ease-out text-white overflow-hidden " :class="{'h-28 opacity-100': showingSubNavigationRepoLinks, ' h-0 opacity-20 ': ! showingSubNavigationRepoLinks}" >
                        <NavLink class="hover:pl-5" :href="route('dashboard')" >Purchases Report</NavLink>
