    ...
    <MainLayout >
        ...
        <div class="max-w-7xl m-auto p-5 bg-white flex flex-col space-y-2  rounded-xl mt-5" >
            ...
            <div class=" w-full hidden bg-gray-400 p-2 rounded-md space-x-2 md:flex justify-between">
                ...
                <p class=" w-2/6">PV No</p>
                <p class=" w-2/6">Bill No</p>
                <p class=" w-2/6">Supplyer Name</p>
            ...
            <div class=" flex flex-col space-y-2 h-[75vh] md:h-[80vh] my-20 overflow-y-scroll scrollbar-hide ">
                <NavLink :href="route('dashboard')" class="p-0 mt-0" >
                    <TableRow class=" text-gray-900">
                        <template #row-data >
                            <p class="md:w-2/6 before:text-gray-400 beforetext-xs before:md:hidden before:content-['Date']"> 2022-12-12</p>
                            <p class="md:w-2/6 before:text-gray-400 beforetext-xs before:md:hidden before:content-['Invoice-No']"> GF-2022-01212</p>
                            <p class="md:w-2/6 before:text-gray-400 beforetext-xs before:md:hidden before:content-['Bill-No']"> 1212</p>
                            <p class="md:w-2/6 before:text-gray-400 beforetext-xs before:md:hidden before:content-['Customer-Name']"> Seafaari</p>
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Diesel']"> 2,350</p>
                                <p class="before:text-gray-400 beforetext-xs before:content-['|']"> 19.50</p>
                            </div>
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Petrol']"> 350</p>
                                <p class="before:text-gray-400 beforetext-xs before:content-['|']"> 19.50</p>
                            </div>
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Remula']"> 50</p>
                                <p class="before:text-gray-400 beforetext-xs before:content-['|']"> 60.00</p>
                            </div>
                            <p class=" md:w-2/6 text-center p-2 md:p-0 text-lg md:text-sm text-green-700"><strong class="text-gray-400 text-xs p-1 md:hidden">Total</strong> 25,610.00 MVR</p>
                ...
                <NavLink :href="route('dashboard')" class="p-0 mt-0" >
                    <TableRow class=" text-gray-900">
                        <template #row-data >
                            ...
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Remula']"> 0</p>
                                <p class="before:text-gray-400 beforetext-xs before:content-['|']"> 0.00</p>
                            </div>
                            <p class=" md:w-2/6 text-center p-2 md:p-0 text-lg md:text-sm text-green-700"><strong class="text-gray-400 text-xs p-1 md:hidden">Total</strong> 25,610.00 MVR</p>
                            <p class=" md:w-1/6 text-center md:text-right text-green-700"><strong class="text-gray-400 text-xs p-1 md:hidden">Status</strong> PAID</p>
                        </template>
