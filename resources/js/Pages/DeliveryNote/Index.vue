    ...
    <MainLayout >
        ...
        <div class="max-w-7xl m-auto p-5 bg-white flex flex-col space-y-2  rounded-xl mt-5" >
            <div class="w-100 flex justify-between">
                <NavLink class="w-fit" :href="route('delivery-note.create')"  @click="isLoading = 'true'" >
                ...
                <NavLink :href="route('dashboard')" class="p-0 mt-0" >
                    <TableRow class=" text-gray-900">
                        <template #row-data >
                            ...
                            <p class="md:w-2/6 before:text-gray-400 beforetext-xs before:md:hidden before:content-['Delivery-No']"> GF-2022-01212</p>
                            ...
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Diesel-D']"> 2,350</p>
                            </div>
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Petrol']"> 2,350</p>
                            </div>
                            <div class=" md:w-2/6  flex justify-end md:justify-center  space-x-2">
                                <p class="before:text-gray-400 beforetext-xs before:md:hidden before:content-['Remula']"> 2,350</p>
                            </div>

                            <p class=" md:w-1/6 text-center md:text-right text-green-700"><strong class="text-gray-400 text-xs p-1 md:hidden">Status</strong> Pending</p>
                        </template>
                    </TableRow>
                </NavLink>
